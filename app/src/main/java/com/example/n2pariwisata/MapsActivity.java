...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String[] nama,id,alamat,rating,gambar;
    int jumData;
    ...
    private void getlokasi(){
        String url="https://gisn2pariwisata.000webhostapp.com/n2pariwisata.php";
                    ...
                    @Override
                        ...
                        for (int i = 0; i < jumData; i++) {
                            try {
                                ...
                                lating[i] = new LatLng(data.getDouble("latitude"), data.getDouble("longitude"));
                            ...
                            mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(lating[i], 15.5f));
                        }
                                ...
                                for (int i=0;i<jumData;i++){
                                    if (marker.getTitle().equals(nama[i])){
                                        if(Marker0[i]){
                                            ...
                                            DetailActivity.rating = rating[i];
